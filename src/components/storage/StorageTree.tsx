...
import { ChevronRight, ChevronDown, Plus, Folder, FolderOpen, MoreVertical } from "lucide-react";
...
export function StorageTree({ tree, selectedNodeId, onSelectNode, onTreeChange }: StorageTreeProps) {
            ...
            <div className="space-y-1">
                {tree.length === 0 ? (
                    <div className="text-center py-8 text-text-muted text-sm">
                        No locations yet. Add a root location to begin.
                    </div>
                ) : (
                    tree.map(node => (
                        <TreeNode 
